...
import com.pucese.aplicacion.Exception.CustomeFieldValidationException;
import com.pucese.aplicacion.Exception.UsernameOrIdNotFound;
import com.pucese.aplicacion.dto.ChangePasswordForm;
import com.pucese.aplicacion.entity.Role;
import com.pucese.aplicacion.entity.User;
import com.pucese.aplicacion.repository.RoleRepository;
...
public class UserController {
	...
	/*recuperar contraseña por whatsaap
	@PostMapping("/forgot/whatsaap")
	public ResponseEntity posWhatsaap(@Valid @RequestBody User form, Errors errors) {
		try {
			if( errors.hasErrors()) {
				String result = errors.getAllErrors()
                        .stream().map(x -> x.getDefaultMessage())
	...
	public ResponseEntity posEmail(@Valid @RequestBody User form, Errors errors) {
		try {
			if( errors.hasErrors()) {
				String result = errors.getAllErrors()
                        .stream().map(x -> x.getDefaultMessage())
